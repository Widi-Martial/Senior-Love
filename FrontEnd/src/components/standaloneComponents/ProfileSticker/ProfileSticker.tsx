...
function ProfileSticker({ user }: ProfileStickerProps) {
  return (
    ...
    >
      <div className="h-64 w-64 2xl:w-80 rounded-xl mx-auto shadow-lg relative">
        <img
          src={user.picture}
          alt={user.name}
          className="object-cover rounded-xl h-64 w-64 2xl:w-80"
        />
        ...
        <button
          ...
          onClick={() => console.log('Envoyer un message')}
        >
          <img
            src={messageIcon}
            alt="message"
